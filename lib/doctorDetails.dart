              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    ListView.builder(
                        shrinkWrap: true,
                        itemCount:  data["qualification"][0]["code"]["text"] == null ? 0 :data["qualification"][0]["code"]["text"].length,
                        itemBuilder: (BuildContext content, int index) {
                          return ListTile(
                            leading: Icon(Icons.work),
                            title: Text("Qualification: " + data["qualification"][0]["code"]["text"],
                              style: TextStyle(
                                fontSize: 18.0,
                                color: Colors.grey.shade800,
                              ),
                    ...
                    ListView.builder(
                        shrinkWrap: true,
                        itemCount:  data["qualification"][0]["issuer"]["reference"] == null ? 0 : data["qualification"][0]["issuer"]["reference"].length,
                        itemBuilder: (BuildContext content, int index) {
                          return ListTile(
                            leading: Icon(Icons.work),
                            title: Text("Issues: " + data["qualification"][0]["issuer"]["reference"],
                              style: TextStyle(
                                fontSize: 18.0,
                                color: Colors.grey.shade800,
                              ),
